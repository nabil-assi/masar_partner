          ...
          <div className="w-full lg:flex-1 text-center lg:text-right text-white space-y-6">
            <div className="space-y-4">
              ...
              <h2 className="text-3xl md:text-5xl font-bold leading-tight">
                ورشة بناء و تطوير الأنظمة
                <br />
                البرمجية المتكاملة
              </h2>
              <p className="text-gray-100 text-base md:text-lg leading-relaxed max-w-lg mx-auto lg:mx-0">
                انضم إلينا في ورشة عمل مكثفة لمدة 3 أيام لتعلم كيفية بناء هندسة
                برمجية قابلة للتوسع بمشاريع حقيقية.
              </p>
            </div>
            ...
            <div className="flex justify-center lg:justify-end gap-3">
              {[
                ...
                <div
                  key={i}
                  className="bg-black/20 backdrop-blur-md rounded-2xl py-3 px-4 w-[75px] md:w-[80px] text-center border border-white/10"
                >
            ...
            {/* Button */}
            <div className="pt-2">
              <button className="bg-white text-[#FF6D00] font-bold px-8 py-3.5 rounded-full transition-all hover:scale-105 shadow-xl">
                احجز مقعدك الان
              </button>
            </div>
          </div>
