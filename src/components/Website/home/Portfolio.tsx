    ...
    <section className="relative py-24 px-6 bg-white overflow-hidden" dir="rtl">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.5fr] gap-8 items-start">
          ...
          {/* المشروع الرئيسي */}
          <div className="bg-white p-6 rounded-[2rem] border border-gray-100 shadow-[0_10px_40px_rgba(0,0,0,0.05)] h-full">
            ...
            {/* صف الأيقونة والنص أسفل الصورة مباشرة (بدون تعويم) */}
