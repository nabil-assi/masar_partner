...
export const Services = () => {
  return (
    <section className="relative py-24 px-6 md:px-12 lg:px-24 bg-white overflow-hidden" dir="rtl">
      {/* زخرفة الخلفية */}
      <div
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center mb-16">
          <h2 className="text-4xl lg:text-5xl font-bold text-[#011856] mb-6">حلولنا الرئيسية</h2>
          <p className="text-gray-500 text-lg max-w-2xl mx-auto">
            حلول متكاملة لبناء أعمالك الرقمية وتنميتها بثقة، ندمج فيها الإبداع بالتقنية.
          </p>
        </div>
