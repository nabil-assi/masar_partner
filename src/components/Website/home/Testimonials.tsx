...
export const Testimonials = () => {
  return (
    <section className="relative py-24 px-6 bg-gray-50/50 overflow-hidden" dir="rtl">
      {/* زخرفة الخلفية */}
      <div
      ...
      <div className="absolute -bottom-28 -left-20 w-[320px] h-[320px] bg-white rounded-full blur-3xl opacity-70 pointer-events-none" />
