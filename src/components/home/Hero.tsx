      ...
      <div className="w-full max-w-7xl mx-auto  pt-25 flex flex-col lg:flex-row items-center gap-12">
        ...
        <div className="flex-1 space-y-8 text-center lg:text-right z-10">
          ...
          <h1 className="text-4xl md:text-[60px] font-bold text-white leading-tight font-almarai">
            ...
            <span className="text-[#C25101] font-almarai">التميز الرقمي</span>{" "}
            مع أكاديمية مسار
          </h1>
          {/* حقل البحث */}
          <div className="relative w-full max-w-[512px] mx-auto lg:mx-0 lg:ml-auto">
            <Search
            ...
            <input
              ...
              className="w-full bg-[#1e293b] font-almarai text-right text-white py-4 pr-10 pl-12 rounded-[12px] border border-white/10 focus:outline-none focus:border-blue-500 transition-all "
            />
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-end">
            ...
            <button className="flex  font-almarai items-center justify-center gap-2 border border-white/10 hover:bg-white/5 text-white px-8 py-4 rounded-[12px] transition-all">
              <BookOpen size={20} />
              استعراض الدورات
            </button>
          </div>
