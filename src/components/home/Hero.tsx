  ...
  return (
    ...
    <section  className="relative w-full min-h-screen flex items-center bg-gradient-to-br from-[#6D3B15] via-[#1C2134] to-[#0F172A] overflow-hidden pt-24">
      <div className="w-full h-full flex flex-col lg:flex-row items-center gap-12 px-6 md:px-16">
       ...
       {/* حقل البحث */}
<div className="relative w-full max-w-[512px] mx-auto lg:mr-0"> {/* تم تعديل mx-auto لـ lg:mr-0 ليصبح جهة اليمين */}
  <Search
...
{/* الأزرار */}
<div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-end"> {/* تم التأكد من justify-end هنا */}
